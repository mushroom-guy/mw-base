...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("mw19.falima.fire.suppressed")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
SWEP.Customization = {
    {"att_perk", "attachment_vm_ar_falima_perk_soh", "att_perk_fmj"}, 

    {"attachment_vm_ar_falima_barrel", "attachment_vm_ar_falima_barlong", "attachment_vm_ar_falima_barsmg"},

    {"attachment_vm_ar_falima_stock", "attachment_vm_ar_falima_stock_v2", "attachment_vm_ar_falima_stock_v4","attachment_vm_ar_falima_stockl", "att_vm_stock_heavy01", 
    "att_vm_stock_heavy02", "att_vm_stock_light01", "att_vm_stock_medium01", "att_vm_stock_no"},

    {"attachment_vm_ar_falima_mag", "attachment_vm_ar_falima_mmags", "attachment_vm_ar_falima_xmags"},
    
    {"attachment_vm_ar_falima_forend", "attachment_vm_ar_falima_forend_v2", "attachment_vm_ar_falima_forend_v4"},

    {"attachment_vm_ar_falima_receiver", "attachment_vm_ar_falima_receiver_v2"},
    ...
    {"att_laser", "attachment_vm_ar_falima_laser01", "attachment_vm_ar_falima_laser02", "attachment_vm_ar_falima_laser03"},
    
    {"att_grip", "attachment_vm_ar_falima_angledgrip01", "attachment_vm_ar_falima_angledgrip02", "attachment_vm_ar_falima_stubbygrip01", 
    "attachment_vm_ar_falima_stubbygrip02", "attachment_vm_ar_falima_vertgrip01", "attachment_vm_ar_falima_vertgrip02", 
    "attachment_vm_ar_falima_vertgrip03"},
}
