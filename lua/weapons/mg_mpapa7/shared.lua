...
if CLIENT then
    killicon.Add( "mg_mpapa7", "VGUI/entities/mg_mpapa7", Color(255, 0, 0, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_sm_mpapa7")
end
...
SWEP.Spawnable = true
SWEP.VModel = Model("models/viper/mw/weapons/v_mpapa7.mdl")
SWEP.WorldModel = Model("models/viper/mw/weapons/w_mpapa7.mdl")

SWEP.Slot = 2
SWEP.HoldType = "TinyGun"
SWEP.Trigger = {
    PressedSound = Sound("mw19.mpapa7.prefire"),
    ReleasedSound = Sound("mw19.mpapa7.disconnector"),
    Time = 0.015
}

SWEP.Primary.Sound = Sound("mw19.mpapa7.fire")
...
SWEP.Shell = {
    Model = Model("models/viper/mw/shells/vfx_rifle_shell_lod0.mdl"),
    Scale = 0.35,
    Force = 100,
