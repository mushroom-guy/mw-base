...
if CLIENT then
    killicon.Add( "mg_galima", "VGUI/entities/mg_galima", Color(255, 0, 0, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_ar_galima")
end
...
SWEP.Spawnable = true
SWEP.VModel = Model("models/viper/mw/weapons/v_galima.mdl")
SWEP.WorldModel = Model("models/viper/mw/weapons/w_galima.mdl")
SWEP.Trigger = {
...
SWEP.Primary.Sound = Sound("mw19.galima.fire")
...
SWEP.Bullet = {
    Damage = {33, 14}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range
