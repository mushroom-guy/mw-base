...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("mw19.mpapa5.fire.9mm.s")
    ...
    self.Primary.Sound = Sound("mw19.mpapa5.fire.s")
    end
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
...
function SWEP:doCalConversionStats()
    ...
    if (!bSup1 && !bSup2 && !bSup3 && !bSup4 && !bSup5 && !bSup6) then
    self.Primary.Sound = Sound("mw19.mpapa5.fire")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
SWEP.Customization = {
    {"att_perk", "attachment_vm_sm_mpapa5_perk_soh", "att_perk_fmj"}, 

    {"attachment_vm_sm_mpapa5_stock", "attachment_vm_sm_mpapa5_stock_fullstock", "attachment_vm_sm_mpapa5_stock_nostock", 
    "att_vm_stock_heavy01", "att_vm_stock_heavy02", 
    "att_vm_stock_light01", "att_vm_stock_medium01", 
    "att_vm_stock_no"},

    {"attachment_vm_sm_mpapa5_mag", "attachment_vm_sm_mpapa5_mag_xmag2", "attachment_vm_sm_mpapa5_mag_xmag"},

    {"attachment_vm_sm_mpapa5_barrel", "attachment_vm_sm_mpapa5_barshort", 
    "attachment_vm_sm_mpapa5_railgrip", "attachment_vm_sm_mpapa5_barrel_noflash",
    "attachment_vm_sm_mpapa5_barrel_suppressor", "attachment_vm_sm_mpapa5_barrel_suppshort"},
    ...
    {"att_grip", "attachment_vm_sm_mpapa5_angledgrip01", "attachment_vm_sm_mpapa5_angledgrip02", "attachment_vm_sm_mpapa5_stubbygrip01", 
    "attachment_vm_sm_mpapa5_stubbygrip02", "attachment_vm_sm_mpapa5_vertgrip01", "attachment_vm_sm_mpapa5_vertgrip02", 
    "attachment_vm_sm_mpapa5_vertgrip03"},
}
