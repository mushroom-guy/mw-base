...
ATTACHMENT.Model = Model("models/viper/mw/attachments/attachment_vm_pi_mike1911_xmags.mdl")
ATTACHMENT.Icon = Material("viper/mw/attachments/icons/mike1911/icon_attachment_pi_mike1911_xmags.vmt")
