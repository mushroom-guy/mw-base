...
ATTACHMENT.Model = Model("models/viper/mw/attachments/mpapa7/attachment_vm_sm_mpapa7_mmags.mdl")
ATTACHMENT.Icon = Material("viper/mw/attachments/icons/mpapa7/icon_attachment_sm_mpapa7_mmags.vmt")
