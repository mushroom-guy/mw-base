...
SWEP.Customization = {
    {"att_perk", "attachment_vm_ar_scharlie_perk_soh", "att_perk_fmj"}, 

    {"att_receiver", "attachment_vm_ar_scharlie_receiver_v18"}, 

    {"attachment_vm_ar_scharlie_barrel", "attachment_vm_ar_scharlie_barrel_v18", "attachment_vm_ar_scharlie_barrel_pdw", "attachment_vm_ar_scharlie_barrel_mid", "attachment_vm_ar_scharlie_barrel_long"},

    {"attachment_vm_ar_scharlie_mag", "attachment_vm_ar_scharlie_mag_dmr", "attachment_vm_ar_scharlie_mag_v18", "attachment_vm_ar_scharlie_mmags", "attachment_vm_ar_scharlie_xmags"},

    {"attachment_vm_ar_scharlie_stock", "attachment_vm_ar_scharlie_stock_v18", "attachment_vm_ar_scharlie_stock_light", "attachment_vm_ar_scharlie_stock_dmr", "att_vm_stock_heavy01", 
    ...
    {"att_laser", "attachment_vm_ar_scharlie_laser01", "attachment_vm_ar_scharlie_laser02", "attachment_vm_ar_scharlie_laser03"},
    
    {"att_grip", "attachment_vm_ar_scharlie_angledgrip01", "attachment_vm_ar_scharlie_angledgrip02", "attachment_vm_ar_scharlie_stubbygrip01", 
    "attachment_vm_ar_scharlie_stubbygrip02", "attachment_vm_ar_scharlie_vertgrip01", "attachment_vm_ar_scharlie_vertgrip02", 
    "attachment_vm_ar_scharlie_vertgrip03"},
}
