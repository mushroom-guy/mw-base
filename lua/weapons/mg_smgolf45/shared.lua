...
SWEP.Primary.Sound = Sound("mw19.smgolf45.fire")
...
SWEP.Cone = {
    ...
    Increase = 0.062, --increase cone size by this amount every time we shoot
...
SWEP.Recoil = {
    Vertical = {1, 1.3}, --random value between the 2
    Horizontal = {-0.7, 0.7}, --random value between the 2
