...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("mw19.victor.fire.s")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
SWEP.Customization = {
    ...
    {"attachment_vm_sm_victor_mag", "attachment_vm_sm_victor_smags", "attachment_vm_sm_victor_drummag"},

    {"attachment_vm_sm_victor_barrel", "attachment_vm_sm_victor_barlong", 
    "attachment_vm_sm_victor_barsil"},
    ...
    "att_vm_silencer04", "att_vm_silencer05", "att_vm_silencer06", "attachment_vm_sm_victor_suppressor"},
    ...
    {"att_laser", "attachment_vm_sm_victor_laser01", "attachment_vm_sm_victor_laser02", 
    "attachment_vm_sm_victor_laser03"},

    {"att_grip", "attachment_vm_sm_victor_angledgrip01", "attachment_vm_sm_victor_angledgrip02", "attachment_vm_sm_victor_stubbygrip01", 
...
--         Slot = 2,
--         {
--             Key = "attachment_vm_sm_victor_barrel",
--         },
--         {
--             Key = "attachment_vm_sm_victor_barlong",
--             Bodygroups = {
--                 ["tag_tip"] = 2
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_sm_victor_barsil",
--             Bodygroups = {
--                 ["tag_tip"] = 6
--             },
--             ExcludedAttachments = {
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(0.11, 3, -0.23)
--             end
--         },        
--         {
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(-0.007, 3, -0.334)
--             end
--         },        
--         {
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(-0.006, 3, -0.23)
--             end
--         },
--         {
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(-0.002, 3, -0.16)
--             end
--         }, 
--         {
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(-0.002, 3, 0.26)
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(-0.003, 3, 0.275)
--             end
--         }, 
--         {
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(-0.008, 5, -0.115)
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(-0.003, 5, -0.05)
--                 self.Zoom.Blur.EyeFocusDistance = 3.5
--             end
--         }, 
--         {
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(0.005, 3, 0.12)
--                 self.HybridAimAngles = Angle(-0.02, 0.02, 0)
--                 self.HybridAimPos = Vector(0,2,-1.1)
--             end
--         }, 
--         {
...
--             },
--             Stats = function(self)
--                 self.ViewModelOffsets.Aim.Pos = self.ViewModelOffsets.Aim.Pos + Vector(-0.0075, 3, 0.19)
--                 self.Zoom.Blur.EyeFocusDistance = 3.5
--                 self.HybridAimAngles = Angle(0, 0.015, -45)
--                 self.HybridAimPos = Vector(-1.55, 5, 1)
--             end
--         }, 
--     },
...
--         },
--         {
--             Key = "attachment_vm_sm_victor_suppressor",
--             Bodygroups = {
--                 ["tag_tip"] = 1
--             },
--             VElement = {
...
--         Slot = 7,
--         {
--             Key = "attachment_vm_sm_victor_stock",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_sm_victor_stockh",
--             Bodygroups = {
--                 ["tag_stock_attach"] = 1
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_sm_victor_stocks",
--             Bodygroups = {
--                 ["tag_stock_attach"] = 1
--             },
--             Stats = function(self)
...
--         },
--         {
--             Key = "attachment_vm_sm_victor_stocksn",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_sm_victor_stockno",
--             Bodygroups = {
--                 ["tag_stock_attach"] = 1
--             },
--             Stats = function(self)
...
--         Slot = 5,
--         {
--             Key = "attachment_vm_sm_victor_mag",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_sm_victor_smags",
--             Stats = function(self)
--             end
--         },
--         {
--             Key = "attachment_vm_sm_victor_drummag",
--             Stats = function(self)
--             end
--         },
--     },
