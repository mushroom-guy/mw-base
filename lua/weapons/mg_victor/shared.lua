...
if CLIENT then
    killicon.Add( "mg_victor", "VGUI/entities/mg_victor", Color(255, 0, 0, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_sm_victor")
end
...
SWEP.Spawnable = true
SWEP.VModel = Model("models/viper/mw/weapons/v_victor.mdl")
SWEP.WorldModel = Model("models/viper/mw/weapons/w_victor.mdl")

SWEP.Slot = 2
SWEP.HoldType = "TinyGun"
SWEP.Trigger = {
    PressedSound = Sound("mw19.victor.prefire"),
    ReleasedSound = Sound("mw19.victor.disconnector"),
    Time = 0.015
}

SWEP.Primary.Sound = Sound("mw19.victor.fire")
