...
SWEP.Customization = {
    {"att_perk", "attachment_vm_ar_mcharlie_perk_soh", "att_perk_fmj"}, 

    {"attachment_vm_ar_mcharlie_barrel", "attachment_vm_ar_mcharlie_barrel_v17", "attachment_vm_ar_mcharlie_longbarrel", "attachment_vm_ar_mcharlie_shortbarrel", "attachment_vm_ar_mcharlie_suppressorbarrel"},

    {"attachment_vm_ar_mcharlie_stock", "attachment_vm_ar_mcharlie_stock_v2", "attachment_vm_ar_mcharlie_lightstock", "att_vm_stock_heavy01", 
    "att_vm_stock_heavy02", "att_vm_stock_light01", "att_vm_stock_medium01", "att_vm_stock_no"},

    {"attachment_vm_ar_mcharlie_receiver", "attachment_vm_ar_mcharlie_receiver_v17"},

    {"attachment_vm_ar_mcharlie_mag", "attachment_vm_ar_mcharlie_mag_v17", "attachment_vm_ar_mcharlie_magsub", "attachment_vm_ar_mcharlie_xmags", "attachment_vm_ar_mcharlie_xmags2"},
    ...
    {"att_laser", "attachment_vm_ar_mcharlie_laser01", "attachment_vm_ar_mcharlie_laser02", "attachment_vm_ar_mcharlie_laser03"},
    
    {"att_grip", "attachment_vm_ar_mcharlie_angledgrip01", "attachment_vm_ar_mcharlie_angledgrip02", "attachment_vm_ar_mcharlie_stubbygrip01", 
    "attachment_vm_ar_mcharlie_stubbygrip02", "attachment_vm_ar_mcharlie_vertgrip01", "attachment_vm_ar_mcharlie_vertgrip02", 
    "attachment_vm_ar_mcharlie_vertgrip03"},
}
